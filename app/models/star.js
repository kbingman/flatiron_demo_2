...
var Star = resourceful.define('star', function () {
  ...
  self.types = [
    ...
    { code: 'F', frequency: 0.033, name: 'Yellow / White', color: '#ffffbc', radius: 1.3, mass: 1.2, orbits:  { hot: 3, habitable: 2, almosthabitable: 2, cold: 3, verycold: 3 } },
    { code: 'D', frequency: 0.04, name: 'Degenerate', color: '#555555', radius: 0.45, mass: 1, orbits: {} },
    { code: 'G', frequency: 0.077, name: 'Yellow', color: '#ffff62', radius: 1, mass: 1, orbits:  { hot: 2, habitable: 2, almosthabitable: 1, cold: 2, verycold: 2 } },
    { code: 'K', frequency: 0.1165, name: 'Orange', color: '#ffd280', radius: 0.9, mass: 0.6, orbits:  { hot: 1, habitable: 1, almosthabitable: 1, cold: 2, verycold: 1 } },
    { code: 'M', frequency: 0.71, name: 'Red', color: '#c70003', radius: 0.6, mass: 0.27, orbits:  { hot: 4, habitable: 4, almosthabitable: 0, cold: 2, verycold: 1 } }
  ];
